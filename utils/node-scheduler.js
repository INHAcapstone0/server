...
const scheduleCreate = async (schedule) => {
  ...
  global['scheduleStart_' + schedule.id] =
    scheduler.scheduleJob(schedule.startAt, async function () {
      let fcm_token_list = []
  ...
  global['scheduleEnd_' + schedule.id] =
    scheduler.scheduleJob(schedule.endAt, async function () {
      let fcm_token_list = []
      let end_alarm_list = []
