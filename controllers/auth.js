...
const register = async (req, res) => {
  ...
  //기본 유저이미지 둘 중에 하나로 바꾸기
  let default_image_url = (Math.random() < 0.5) ?
    `https://capstone-storage-server.s3.ap-northeast-2.amazonaws.com/defaultUserImage.png` :
    'https://capstone-storage-server.s3.ap-northeast-2.amazonaws.com/defaultUserImage2.png'
